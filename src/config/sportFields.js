/**
 * Sport-specific field definitions for test results (frontend)
 * This matches the backend config but is used for form rendering
 */
 ...
 */
export function getFieldsForSport(sport) {
