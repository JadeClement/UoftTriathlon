...
const AdminIntervalResults = lazy(() => import('./components/admin/AdminIntervalResults'));
      ...
      <main id="main-content" tabIndex={-1} {...swipeHandlers}>
        <Routes>
          ...
          >
            ...
            <Route path="guide" element={<Suspense fallback={routeFallback}><AdminGuide /></Suspense>} />
            <Route path="members" element={<Suspense fallback={routeFallback}><AdminMembers /></Suspense>} />
            <Route path="receipts" element={<Suspense fallback={routeFallback}><AdminReceipts /></Suspense>} />
            <Route path="terms" element={<Suspense fallback={routeFallback}><AdminTerms /></Suspense>} />
            <Route path="email" element={<Suspense fallback={routeFallback}><AdminEmail /></Suspense>} />
            <Route path="banner" element={<Suspense fallback={routeFallback}><AdminBanner /></Suspense>} />
            <Route path="attendance" element={<Suspense fallback={routeFallback}><AdminAttendance /></Suspense>} />
            <Route path="orders" element={<Suspense fallback={routeFallback}><AdminOrders /></Suspense>} />
            <Route path="interval-results" element={<Suspense fallback={routeFallback}><AdminIntervalResults /></Suspense>} />
          </Route>
